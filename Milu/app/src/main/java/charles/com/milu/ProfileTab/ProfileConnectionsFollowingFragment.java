...
public class ProfileConnectionsFollowingFragment extends Fragment implements ProfileConnectionsFollowingRecyclerViewAdapter.RowClickListener,
    ...
    public ProfileConnectionsFollowingFragment() {
    ...
    private void initSectionPicker() {
        ...
        final String[] sections = Arrays.copyOf(sectionsAsObject, sectionsAsObject.length, String[].class);
