...
/**
 * Created by PIG18 on 4/6/2017.
 */

public class ForegroundHelper implements Application.ActivityLifecycleCallbacks {

    public static final String TAG = ForegroundHelper.class.getName();
    ...
    private static ForegroundHelper instance;
    ...
    public static ForegroundHelper init(Application application){
        if (instance == null) {
            instance = new ForegroundHelper();
            application.registerActivityLifecycleCallbacks(instance);
        }
        return instance;
    }

    public static ForegroundHelper get(Application application){
        if (instance == null) {
            init(application);
        }
        return instance;
