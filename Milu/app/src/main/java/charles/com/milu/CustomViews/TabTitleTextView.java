...
public class TabTitleTextView extends LinearLayout {
    ...
    String title;
    String subtitle;
    public TabTitleTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.VERTICAL);
        LayoutInflater.from(context).inflate(R.layout.profile_tab_item, this, true);
        ...
        try {
            ...
            subtitle = a.getString(R.styleable.profile_tab_style_subtitle);
        ...
        init(title, subtitle, isSelected);
    }

    // Setup views
    private void init(String title, String subtitle, boolean isSelected) {
    ...
    public void setSelect(boolean b){
        if (b){
            ...
            subtitleView.setTypeface(workSans_Light);
            titleView.setTextColor(ContextCompat.getColor(getContext(), R.color.colorWhite));
            subtitleView.setTextColor(ContextCompat.getColor(getContext(), R.color.color_Oldlavender));
