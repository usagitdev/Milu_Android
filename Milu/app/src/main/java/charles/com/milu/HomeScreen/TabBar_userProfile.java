...
import charles.com.milu.Dialog.CustomDialogClass;
 ...
 */
public class TabBar_userProfile extends BaseFragment implements AdapterView.OnItemClickListener{
    ...
    public static TabBar_userProfile getInstance() {
        return new TabBar_userProfile();
    }

    @Override
    protected int addView() {
        return R.layout.fragment_tab_bar_user_profile;
    }
