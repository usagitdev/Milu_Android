...
public class MediaSelectResultGalleryAdapter extends RecyclerView.Adapter<MediaSelectResultGalleryAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            deleteButton = (CustomImageButton) itemView.findViewById(R.id.delete_button);
...
//                        cellVideo.setVideoPath(getVideoUrl());
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mediaObjects.remove(mediaObjects.get(getAdapterPosition()));
                    notifyItemRemoved(getAdapterPosition());
                    listener.mediaDeleteClicked(view, getAdapterPosition());
                }
            });
    ...
    @Override
    public MediaSelectResultGalleryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.media_select_result_gallery_item, parent, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(MediaSelectResultGalleryAdapter.ViewHolder viewHolder, int position) {
...
//            }
    ...
    public void setObject(ArrayList<MediaObject> objects) {
        mediaObjects = objects;
        notifyDataSetChanged();
    }
    ...
    public MediaSelectResultGalleryAdapter(Context context, ArrayList<MediaObject> objects, int numColumnss) {
    ...
    public MediaSelectResultGalleryAdapter.ItemClickListener listener;

    public void setListener(MediaSelectResultGalleryAdapter.ItemClickListener listener){
    ...
    public interface ItemClickListener {
        ...
        void mediaDeleteClicked(View v, int adapterPosition);
    }
}
