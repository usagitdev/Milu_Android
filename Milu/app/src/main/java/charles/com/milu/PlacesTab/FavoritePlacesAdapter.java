...
public class FavoritePlacesAdapter extends RecyclerView.Adapter<FavoritePlacesAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            ...
            mEventranking = (TextView) itemView.findViewById(R.id.favorites);
            mRankingImg = (ImageView) itemView.findViewById(R.id.imv_favorite);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int position) {
        ...
        FavoritePlacesItem eventItem = mContacts.get(position);
...
//        mEventCell.setImageResource(eventItem.getEventImage());
    ...
    private List<FavoritePlacesItem> mContacts;
    // Store the context for easy access

    private Context mContext;

    // Pass in the contact array into the constructor
    public FavoritePlacesAdapter(Context context, List<FavoritePlacesItem> contacts) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View contactView = inflater.inflate(R.layout.favorite_places_cell, parent, false);
