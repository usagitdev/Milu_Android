...
//                        cellVideo.setVideoPath(getVideoUrl());
    ...
    public GalleryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.gallery_media_item, parent, false);
    ...
    public GalleryAdapter(Context context, ArrayList<MediaObject> objects) {
    ...
    public GalleryAdapter.ItemClickListener listener;

    public void setListener(GalleryAdapter.ItemClickListener listener){
