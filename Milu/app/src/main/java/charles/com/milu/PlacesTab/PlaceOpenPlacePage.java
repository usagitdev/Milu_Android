 ...
 */
public class PlaceOpenPlacePage extends BaseFragment implements OnMapReadyCallback, GravitySnapHelper.SnapListener, GoogleMap.OnMarkerClickListener {

    @BindView(R.id.open_place_Map)
    MapView mapView;

    @BindView(R.id.open_place_ScrollView)
    NestedScrollView mScrollview;
    @BindView(R.id.liveEventButton)
    ImageButton liveEventButton;
    @BindView(R.id.open_place_event_image)
    ImageView eventImageView;


    @BindView(R.id.open_place_CommentRecyclerView)
    RecyclerView commentRecyclerView;

    @BindView(R.id.open_place_LikeRecyclerView)
    RecyclerView likeRecyclerView;

    @BindView(R.id.open_place_PeopleRecyclerView)
    RecyclerView peopleRecyclerView;

    @BindView(R.id.recycler_pastEvent)
    RecyclerView recyclerViewPastEvent;

    public static PlaceOpenPlacePage getInstance() {
        // Required empty public constructor
        PlaceOpenPlacePage fragment = new PlaceOpenPlacePage();
        return fragment;
    }
...
//                addChildFragment(LiveFeedMainFragment.getInstance(), true);
    ...
    protected int addView() {
        return R.layout.fragment_open_place_page;
    }
    ...
    @OnClick(R.id.open_place_event_image)
...
//        addChildFragment(EventPagePosterFragment.getInstance(), true);
    ...
    public void setRecyclerView() {
        ...
        recyclerViewPastEvent.setLayoutManager(new LinearLayoutManager(mAct, LinearLayoutManager.HORIZONTAL, false));
    }
