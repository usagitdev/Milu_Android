...
public class AppConstants {
     ...
     */
    // backend server URL
    public static final String BACKEND_BASE_URL = "http://development.happydemy.com:8443/";
    ...
    public static final String INVITE_MESSAGE_SMS = "Hello get " + MiluApplication.getInstance().getString(R.string.app_name) + " so we can easily chat  with each other !  ";// this is the sms to invite  friends
    public static final String JOINED_MESSAGE_SMS = "Hi there! i'm using " + MiluApplication.getInstance().getString(R.string.app_name);// this is the msg when the user join to the app
     ...
     */
    public static final int MESSAGE_COLOR_ERROR = R.color.colorAccent;
    public static final int MESSAGE_COLOR_WARNING = R.color.color_Milumain;
    public static final int MESSAGE_COLOR_SUCCESS = R.color.color_Onyx;
    ...
    public static final String SOCKET_DELETE_MESSAGE_SERVER = "delete message";
    public static final String SOCKET_EDIT_MESSAGE_SERVER = "edit message";
    ...
    public static final int IS_EDIT = 4;
    public static final int IS_DELETE = 5;
    /**
     * images size
     */
    ...
    public static final String EVENT_BUS_EDIT_MESSAGE_MESSAGES = "edit_message_messages_new_row";
    public static final String EVENT_BUS_DELETE_MESSAGE_MESSAGES = "delete_message_messages_new_row";
    ...
    public static final String EVENT_BUS_MESSAGE_IS_EDIT_FOR_CONVERSATIONS = "message_edit_for_conversation";
    ...
    public static final String EVENT_BUS_EDIT_CONVERSATION_ITEM = "editConversation";
    public static final String EVENT_BUS_EDIT_MESSAGE_ITEM = "editMessage";
    ...
    public static final String EVENT_BUS_MESSAGE_IS_EDIT_FOR_MESSAGES = "message_edit_for_messages";
    ...
    public static String EXPORT_REALM_FILE_NAME = MiluApplication.getInstance().getString(R.string.app_name) + "_msgstore.realm";
    ...
    public static final String SELECT_MEDIA_SELECT_ITEM = "SELECT_MEDIA_SELECT_ITEM";
